      ...
      <LayoutDashboardSub fullHeight>
        ...
        <Flex flexDirection="column" sx={{ alignItems: 'center', zIndex: 2 }}>
          ...
          <Flex
            flexDirection="row"
            gap={4}
            sx={{ color: (theme) => (theme.palette.mode === 'dark' ? '#cdbb91' : '#9b7040') }}
          >
              ...
              >
                <Box
                  sx={{
                    ...
                    borderRadius: '8px',
                    border: (theme) =>
                      theme.palette.mode === 'dark' ? '1px solid #d8ad45' : '1px solid #9b7040',
                    overflow: 'hidden',
                    color: (theme) => (theme.palette.mode === 'dark' ? '#f7efd8' : '#273c3d'),
                    background: (theme) =>
                ...
                >
                  <Box sx={{ position: 'relative', p: 4 }}>
                    <Typography
                      variant="caption"
                      sx={{ letterSpacing: 1, color: (theme) => (theme.palette.mode === 'dark' ? '#cdbb91' : '#6f6045') }}
                    >
                      AKITA CREDENTIAL
                    </Typography>
                    <Typography
                      variant="h5"
                      sx={{ mt: 1, color: (theme) => (theme.palette.mode === 'dark' ? '#f7efd8' : '#273c3d') }}
                    >
                      Autumn Field ID
                    </Typography>
                    <Box
                    ...
                    <Typography
                      variant="body2"
                      sx={{ mt: 3, color: (theme) => (theme.palette.mode === 'dark' ? '#cdbb91' : '#6f6045') }}
                    >
                      Issued
                    </Typography>
                    ...
                    <Typography
                      variant="body2"
                      sx={{ mt: 2, color: (theme) => (theme.palette.mode === 'dark' ? '#cdbb91' : '#6f6045') }}
                    >
                      Holder
                    </Typography>
