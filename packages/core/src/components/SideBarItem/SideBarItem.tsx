...
const StyledListItemIcon = styled(ListItemIcon)`
  ...
  box-shadow: ${({ selected, theme }) =>
    selected
      ? `0 10px 24px ${alpha('#0f1a12', theme.palette.mode === 'dark' ? 0.26 : 0.24)}`
      : 'none'};
  transition:
...
const StyledListItem = styled(ListItem)`
  ...
  &:hover ${StyledListItemIcon} {
    ...
    svg {
      color: ${({ theme }) =>
        theme.palette.mode === 'dark' ? theme.palette.sidebarIconHover.dark : theme.palette.sidebarIconHover.main} !important;
    }
